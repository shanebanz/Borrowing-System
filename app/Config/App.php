...
class App extends BaseConfig
{
     ...
     */
    public string $baseURL = 'http://localhost/SYS/';
    ...
    */
     ...
     * --------------------------------------------------------------------------
     *
     * These settings determine how sessions are managed by CodeIgniter.
     * This is CRITICAL for your authentication system to work.
     */
    public string $sessionDriver = 'CodeIgniter\Session\Handlers\FileHandler';
    public string $sessionCookieName = 'ci_session';
    public int $sessionExpiration = 7200; // 2 hours in seconds
     ...
     * 'cookieSameSite' = Configure cookie SameSite setting (Lax, Strict, None).
     */
